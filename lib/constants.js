...
export const DEFAULT_USE_EXISTING_TABLE: boolean = false;
export const DEFAULT_RANGE_KEY: string = undefined;

// could be a number or string depending on existing table key schema
